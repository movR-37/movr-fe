...
function Itinerary() {
    ...
    let distanceCostString= distance +" km x 1.67 = $" + distanceCost.toFixed(2) 
    ...
    let taxCostString= "($" +distanceCost.toFixed(2) + " + $"+ timeCost.toFixed(2) + ") x " + tax + " = $"+taxCost.toFixed(2)

    let tip = 0.25;
    let tipCost=(distanceCost+timeCost)*tip
    let tipCostString= "($" +distanceCost.toFixed(2) + " + $"+ timeCost.toFixed(2) + ") x " + tip + " = $"+tipCost.toFixed(2)
    ...
    return(
        ...
        <ListItem>
          ...
          <ListItemText primary="Distance Cost" secondary={distanceCostString} />
        </ListItem>
        <Divider />
        <ListItem>
          <ListItemAvatar>
